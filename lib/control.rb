...
class Control
	...
	def self.restart_actions(hostname, port, app_name, app_file_name)
	...
	def self.start_actions(hostname, app_name, port, app_file_name)
	...
	def self.stop_actions(app_name, port)
